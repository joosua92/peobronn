					...
					<div class="container pull-right" id="konto-lingid-konteiner">
						<div class="pull-right">
							<ul class="list-inline" id="konto-lingid">
								<li><a href="#" id="est-flag" title="Estonian"><img src="<?php echo base_url(); ?>assets/images/flags/est.jpg" class="lang-flag" alt="estonian" /></a></li>
								<li><a href="#" id="eng-flag" title="English"><img src="<?php echo base_url(); ?>assets/images/flags/eng.jpg" class="lang-flag" alt="english" /></a></li>
